            ...
            <div class="card-body pt-4">
                <div class="row my-3">
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <input class="form-control" required type="date" id="dateAttendance" value="{{ date('Y-m-d') }}"
                            name="dateAttendance">
                    </div>
                    <div class="col-12 text-end">
                        <button onclick="fetchStudents()" type="submit" class="btn btn-primary me-2">Take
                            Attendance</button>
                    </div>
                </div>
            </div>
