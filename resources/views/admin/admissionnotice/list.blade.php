...
<section class="section">
    ...
    @include('admin.admissionnotice.add')
        ...
        var table = $('#DataTables').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    "data": "id",
                    "render": function(data, type, row) {
                        return '<a class="btn btn-danger btn-sm rounded-pill show_confirm" href="javascript:void(0)" onclick="deleteadminotice(' + '`' + data + '`' + ')"><i class="bi bi-trash"></i></a>';
                    }
                }
            ],
            'columnDefs': [
