                ...
                <form action="{{ route('ams.addSessionTerm') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" id="session_name" class="form-control" placeholder="Enter Session"
                                name="session_name" required>
                        </div>
                        <div class="col-4 mb-4">
                            <label class="form-label">Start Date<span class="text-danger">*</span></label>
                            <input type="date" id="section_valid_from" class="form-control" name="section_valid_from"
                                required>
                        </div>
                        <div class="col-4 mb-4">
                            <label class="form-label">End Date<span class="text-danger">*</span></label>
                            <input type="date" id="section_valid_to" class="form-control" name="section_valid_to"
                                required>
                        </div>
                        <div class="col-4 mb-4">
                        ...
                        <div class="col-8 d-flex align-items-center justify-content-end">
                            <a type="button" href="javascript:void(0)" onclick="reload()" id="reset"
                                class="btn btn-secondary me-2">Clear</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a class="btn btn-primary btn-sm rounded-pill me-2" href="javascript:void(0)"
                                                onclick="editClass({{ @$item }})"><i class="bi bi-pencil-square"></i>
                                            </a>
