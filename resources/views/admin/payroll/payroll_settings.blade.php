                ...
                <div class="row my-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="Allowances" value="Allowances" name="type" checked onchange="GetPayrollType()">
                            <label class="form-check-label" for="Allowances">Allowances</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="Deductions" value="Deductions" name="type" onchange="GetPayrollType()">
                    ...
                    <div class="col-6 mb-4">
                      ...
                      <div class="col-4 mb-4">
                        ...
                        <input type="number" class="form-control" placeholder="Enter fixed amount"  name="fixed_amount" id="fixed_amount">
                    ...
                    <div class="col-4 mb-4">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" value="applied" name="apply_on_fee_Settings" id="apply_on_fee_Settings">
                        </div>
                    </div>
                    <div class="col-12 text-end">
                        <button type="submit" id="add_payroll_settings" class="btn btn-success" >Add Payroll</button>
                        <button type="submit" id="update_payroll_settings" class="btn btn-primary" >Update Payroll</button>
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, payroll) {
                        table.row.add([
                            ...
                            '<a class="btn btn-primary btn-sm rounded-pill me-2" href="javascript:void(0)" onclick=\'EditPayRollSettings('  + JSON.stringify(payroll) + ')\'><i class="bi bi-pencil-square"></i></a>' +
                            '<a class="btn btn-danger btn-sm rounded-pill show_confirm" href="javascript:void(0)" onclick="deletePayrollSettings(\'' + payroll.id + '\')"><i class="bi bi-trash"></i></a>'
                        ]);
                    });
