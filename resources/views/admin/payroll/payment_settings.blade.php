                ...
                <form id="formData" action="{{ route('paymentsettings.store') }}" method="post">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" id="add_payment_settings" class="btn btn-success">Add Fee
                                Settings</button>
                            <button type="submit" id="update_payment_settings" class="btn btn-primary">Update Fee
                                Settings</button>
            ...
            if (session_id) {
                $.ajax({
                    ...
                    success: function(response) {
                        table.clear();
                        var feeComponents = @json(GetPayrollComponent('fee_settings'));
