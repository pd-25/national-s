            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        return '<a class="btn btn-primary btn-sm rounded-pill me-2" href="javascript:void(0)" onclick="viewNews(' + '`' + encodeURIComponent(rowData) + '`' + ')"><i class="bi bi-pencil-square"></i> </a><a class="btn btn-danger btn-sm rounded-pill show_confirm" href="javascript:void(0)" onclick="deleteNews(' + '`' + data + '`' + ')"><i class="bi bi-trash"></i></a>';
                    }
                }
            ],
            'columnDefs': [
