            ...
            <form action="{{route('student.storeStudentDetails')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-1">
                        ...
                        <input type="text" id="student_name" class="form-control" name="student_name" required value="{{old('student_name')}}">
                        @if ($errors->has('student_name'))
                            <span class="text-danger">{{ $errors->first('student_name') }}</span>
                        @endif
                    </div>
                    <div class="col-4 mb-1">
                        <label for="" class="form-label">Admission sought for class: <span class="text-danger">*</span></label>
                    ...
                    <div class="col-4 mb-1">
                        ...
                        <input type="number" id="aadhar_no" class="form-control" name="aadhar_no"  value="{{old('aadhar_no')}}">
                    ...
                    <div class="col-12 mb-1">
                        ...
                        <textarea id="address" class="form-control" rows="4" name="address">{{old('address')}} </textarea>
                    ...
                    <div class="col-4 mb-1">
                        ...
                        <input type="number" id="pin_code" class="form-control" name="pin_code"  value="{{old('pin_code')}}">
                    ...
                    <div class="col-12 mb-1">
                        <label for="brief_history" class="form-label">Please mention, in brief, if there is any history of previous illness :</label>
                        <textarea id="brief_history" class="form-control" rows="4" name="brief_history">{{old('brief_history')}} </textarea>
                        @if ($errors->has('brief_history'))
                            <span class="text-danger">{{ $errors->first('brief_history') }}</span>
                        @endif
                    </div>
                    <div class="col-12 my-3">
                    ...
                    <div class="col-4 mb-1">
                        ...
                        <input type="text" id="parent_aadhar_number" class="form-control" name="parent_aadhar_number" value="{{old('parent_aadhar_number')}}">
                    ...
                    <div class="col-4 mb-1">
                        ...
                        <input type="text" id="annual_income" class="form-control" name="annual_income" value="{{old('annual_income')}}">
                    ...
                    <div class="col-12 mb-1">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="transport_facility" value="Yes" id="inlineCheckbox1" value="option1">
                            <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="transport_facility" type="checkbox" value="Yes" id="inlineCheckbox2" value="option2">
                    ...
                    <div class="col-12 mb-1">
                        <label for="brief_history" class="form-label">Route </label>
