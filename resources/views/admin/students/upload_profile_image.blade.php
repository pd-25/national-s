    ...
    <script>
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(index, student) {
                        table.row.add([
                            ...
                            "<img src=" + student.student_details.image +
                            " class='img_fluid' style='height:80px;' />",
                            "<input type='file' class='form-control' name='image' onchange='uploadStudentImage(this, " +
        ...
        function uploadStudentImage(input, studentId) {
            if (input.files[0].size > 1500000) {
                Notiflix.Notify.failure("Image size must be less the 1.5 Mb");
                return false;
            }
