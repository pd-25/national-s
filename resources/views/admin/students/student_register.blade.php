                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <div class="image-upload-wrapper">
                                <img src="{{ asset('assets/admin/img/upload.png') }}"
                                    class="rounded-circle prof-photo img-thumbnail" alt="Image"
                        ...
                        <div class="col-12 mb-1">
                            <label for="student_name" class="form-label">Name of Pupil(In Capital Letters)<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="student_name" class="form-control text-uppercase" name="student_name"
                        ...
                        <div class="col-4 mb-1">
                            <label for="" class="form-label">Admission sought for the class: <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-4 mb-1">
                            <label for="" class="form-label">Academic Section: <span
                                    class="text-danger">*</span></label>
                                ...
                                @if (!@empty(GetSession('all_session')))
                                    @foreach (GetSession('all_session') as $index => $item)
                                        <option value="{{ @$item->id }}" {{ $item->status == 1 ? 'selected' : '' }}>
                                            {{ @$item->sessions_name }}</option>
                                    @endforeach
                                @endif
                            </select> --}}
                            <select name="session_id" id="session_id" class="form-select" required>
                                @foreach (GetSession('all_session') as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('session_id', $item->status == 1 ? $item->id : '') == $item->id ? 'selected' : '' }}>
                                        {{ $item->sessions_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <input type="text" id="aadhar_no" class="form-control" maxlength="12" name="aadhar_no"
                                value="{{ old('aadhar_no') }}">
                            ...
                            <select name="religion" class="form-select" id="religion">
                                ...
                                @foreach (Religion() as $item)
                                    <option value="{{ $item['name'] }}"
                                        {{ old('religion') == $item['name'] ? 'selected' : '' }}>
                                        {{ $item['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <input type="number" id="pin_code" class="form-control" required name="pin_code"
                                value="{{ old('pin_code') }}">
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <input type="text" id="mother_tongue" class="form-control" name="mother_tongue"
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <select name="blood_group" class="form-select" id="blood_group">
                                ...
                                @foreach (BloodGroup() as $item)
                                    <option value="{{ $item['name'] }}"
                                        {{ old('blood_group') == $item['name'] ? 'selected' : '' }}>
                                        {{ $item['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 d-flex">
                            {{-- <div class="form-check me-3">
                                <input class="form-check-input" name="stream" type="checkbox" value="Science"
                                    id="flexCheckScience">
                            ...
                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream" type="checkbox" value="Commerce"
                                    id="flexCheckCommerce">
                                <label class="form-check-label" for="flexCheckCommerce">
                                    Commerce
                                </label>
                            </div>
                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream" type="checkbox" value="Humanities"
                                    id="flexCheckHumanities">
                                <label class="form-check-label" for="flexCheckHumanities">
                                    Humanities
                                </label>
                            </div>
                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream" type="checkbox" value="Combination"
                                    id="flexCheckCombination">
                            ...
                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream[]" type="checkbox" value="Science"
                                    {{ in_array('Science', old('stream', [])) ? 'checked' : '' }}>
                                <label class="form-check-label">Science</label>
                            </div>

                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream[]" type="checkbox" value="Commerce"
                                    {{ in_array('Commerce', old('stream', [])) ? 'checked' : '' }}>
                                <label class="form-check-label">Commerce</label>
                            </div>

                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream[]" type="checkbox" value="Humanities"
                                    {{ in_array('Humanities', old('stream', [])) ? 'checked' : '' }}>
                                <label class="form-check-label">Humanities</label>
                            </div>

                            <div class="form-check me-3">
                                <input class="form-check-input" name="stream[]" type="checkbox" value="Combination"
                                    {{ in_array('Combination', old('stream', [])) ? 'checked' : '' }}>
                                <label class="form-check-label">Combination</label>
                            </div>

                            <div class="me-3">
                                <input type="text" class="form-control" name="combination_text"
                                    placeholder="Enter Combination stream">
                            </div>
                        ...
                        <div class="col-12 mb-1">
                            <label for="achievements" class="form-label">Please mention the achievements, if any, of your
                                child in academics / co-curricular activities :</label>
                        ...
                        <div class="col-12 mb-1">
                            <label for="previous_school_info" class="form-label">Please mention, in brief, if there is any
                                history of previous illness :</label>
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" id="parent_name" class="form-control" name="parent_name" required
                        ...
                        <div class="col-4 mb-2">
                            <label for="parent_relation" class="form-label">Relation <span
                                    class="text-danger">*</span></label>
                            ...
                            <select name="parent_relation" class="form-select" id="parent_relation" required>
                                ...
                                @foreach (Relation() as $item)
                                    <option value="{{ $item['name'] }}"
                                        {{ old('parent_relation') == $item['name'] ? 'selected' : '' }}>
                                        {{ $item['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <input type="text" id="parent_aadhar_number" class="form-control" maxlength="12"
                                name="parent_aadhar_number" value="{{ old('parent_aadhar_number') }}">
                        ...
                        <div class="col-4 mb-1">
                            ...
                            <input type="number" id="annual_income" class="form-control" name="annual_income"
                        ...
                        <div class="col-6 mb-1">
                            <label for="office_contact_number" class="form-label">Office Contact Number with extn. (if
                                any)</label>
                            <input type="text" id="office_contact_number" class="form-control"
                                name="office_contact_number" value="{{ old('office_contact_number') }}">
                            @if ($errors->has('office_contact_number'))
                                <span class="text-danger">{{ $errors->first('office_contact_number') }}</span>
                            @endif
                        </div>
                        <div class="col-12 mb-1">
                            <label for="mention_relationship" class="form-label">If Guardian, then mention the
                                relationship with the pupil -</label>
                            <input type="text" id="mention_relationship" class="form-control"
                                name="mention_relationship" value="{{ old('mention_relationship') }}">
                        ...
                        <div class="col-12 mb-1">
                            ...
                            {{-- <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="transport_facility" value="Yes"
                                    id="inlineCheckbox1" value="option1">
                                <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" name="transport_facility" type="radio" value="Yes"
                                    id="inlineCheckbox2" value="option2">
                                <label class="form-check-label" for="inlineCheckbox2">No</label>
                            </div> --}}
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="transport_facility" value="Yes"
                                    {{ old('transport_facility') == 'Yes' ? 'checked' : '' }}>
                                <label class="form-check-label">Yes</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="transport_facility" value="No"
                                    {{ old('transport_facility') == 'No' ? 'checked' : '' }}>
                        ...
                        <div class="col-4 mb-4">
                            ...
                            <input type="text" id="email_address" class="form-control text-lowercase" name="email"
                                value="{{ old('email') }}">
                            @if ($errors->has('email'))
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" onclick="myShowPassword()" type="checkbox"
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="password" id="password_confirmation" class="form-control showPassword"
                        ...
                        <div class="col-12">
                            <button type="reset" id="reset" class="btn btn-secondary">Clear</button>
