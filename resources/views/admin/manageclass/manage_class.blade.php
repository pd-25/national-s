                    ...
                    <form action="{{route('ams.addClasses')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                <label for="" class="form-label">Class <span class="text-danger">*</span></label>
                                <input type="text" id="class_name" class="form-control" placeholder="Enter Class" name="class_name" required>
                            </div>
