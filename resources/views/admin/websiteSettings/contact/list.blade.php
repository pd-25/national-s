                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (data === 0) {
                                badgeHtml = '<span class="badge text-bg-danger p-2" onclick="ChangeStatus(' +
                                    row.id + ', ' + data + ')">Pending</span>';
                            } else if (data === 1) {
                                badgeHtml = '<span class="badge text-bg-success p-2" onclick="ChangeStatus(' +
                                    row.id + ', ' + data + ')">Completed</span>';
                            } else {
                                badgeHtml =
                                    '<span class="badge text-bg-secondary p-2">Unknown</span>'; // Optional: handle other statuses
                            }
                    ...
                    },
                    {
                        "data": "id",
                        "render": function(data, type, row) {
                            return '<a class="btn btn-danger btn-sm rounded-pill show_confirm" href="javascript:void(0)" onclick="deleteContact(' +
