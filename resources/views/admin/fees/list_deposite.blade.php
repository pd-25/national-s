                ...
                <form action="" method="post">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-4 d-flex align-items-center justify-content-end">
                            <a onclick="filterDepositeDetails()" class="btn btn-primary btn-sm"
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, deposite) {
                        ...
                        table.row.add([
                            ...
                            deposite.student_class.class_name + '<br>' + deposite
                            ...
                            '<a class="btn btn-primary btn-sm rounded-pill me-2" href="javascript:void(0)" onclick="EditDeposite(\'' +
                            deposite.payment_number +
                            '\')"><i class="bi bi-pencil-square"></i> </a> <a class="btn btn-success btn-sm rounded-pill" href="javascript:void(0)" onclick="ViewDeposite(\'' +
                            deposite.payment_number +
                            '\')"><i class="bi bi-eye-fill"></i></a>' +
                            '<a class="btn btn-danger btn-sm rounded-pill show_confirm" href="javascript:void(0)" onclick="deleteDeposite(\'' +
                            deposite.id + '\')"><i class="bi bi-trash"></i></a>'
                        ])
                    });
