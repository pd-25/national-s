                ...
                <form action="" method="post">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-4 d-flex align-items-center">
                            <a onclick="filterPaymentDue()" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i
                                    class="bi bi-filter-left"></i> Filter</a>
            ...
            <div class="card border-0">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-end">
                        <a href="javascript:void(0)" id="exportExcel" class="btn btn-secondary btn-sm"><i
                                class="bi bi-file-excel"></i> Export to Excel</a>
                    </div>
    ...
    <script>
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, deposite) {
                            table.row.add([
                                ...
                                deposite.month,
                                deposite.year,
                                "<span class='badge text-bg-danger'>" + deposite.status +
                                "</span>",
                                '<a class="btn btn-primary btn-sm rounded-pill" href="javascript:void(0)" onclick="paymentNow(\'' +
                                deposite.student_id +
                                '\')"><i class="bi bi-credit-card"></i> Pay Now </a>'
                            ])
                        });
                        table.draw();
                    },
        ...
        function paymentNow(student_id) {
            ...
            window.location.href = "fees-payment?session_id=" + session_id + '&class_id=' + class_id + '&section_id=' +
                section_id + '&student_id=' + student_id + '&month=' + month + '&year=' + year;
        }
