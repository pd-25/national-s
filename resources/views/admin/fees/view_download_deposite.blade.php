    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('deposite.edit', @$deposite->payment_number) }}">Edit
                        Payment</a></li>
            ...
            <div class="card-body pt-4">
                <section class="bg-yellow" id="print_payment_slip">
                    ...
                    <table border="1" cellspacing="0" cellpadding="8"
                        style="width:100%; font-family:Arial, sans-serif; border-collapse: collapse;">
                        <tr>
                            <td colspan="2"><strong>Receipt No:</strong> {{ @$deposite->payment_number }}</td>
                            <td colspan="2" style="text-align:right;"><strong>Date:</strong>
                                {{ @$deposite->created_at ? @$deposite->created_at->format('d-m-Y') : '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><strong>Admission No:</strong>
                                {{ @$deposite->studentDetails->admission_number }}</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><strong>For the Month of:</strong> {{ @$deposite->month }},
                                {{ @$deposite->year }}</td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><strong>Amount in Words:</strong>
                                {{ NumberToWord(@$deposite->total_payable) }}</td>
                        </tr>
                        <tr>
                            @if (!@empty($deposite->comments))
                                @foreach ($deposite->comments as $key => $item)
                        <tr>
                            <td colspan="4"> <strong>{{ @$key }}:</strong> {{ @$item }}</td>
                        </tr>
                        @endforeach
                        @endif
                        </tr>
                        <tr>
                            ...
                            @elseif ($deposite->payment_mode == 'Cheque')
                                ...
                                <td><strong>Bank:</strong> {{ @$deposite->bank_name }} <br>
                                    <strong>Branch:</strong> {{ @$deposite->branch }}
                                </td>
                                <td><strong>Date:</strong>
                                    {{ @$deposite->cheque_date ? \Carbon\Carbon::parse(@$deposite->cheque_date)->format('d-m-Y') : '' }}
                                </td>
                            @endif
                        </tr>
                        <tr>
